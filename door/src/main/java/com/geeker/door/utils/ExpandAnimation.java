...
public class ExpandAnimation extends Animation {
	 ...
	 * @param arrow 
	 */
	public ExpandAnimation(View view, int duration, ImageView arrow) {
		...
		//mIsVisibleAfter=isVisibleAfter;
		mMarginStart = mViewLayoutParams.bottomMargin;
		mMarginEnd = (mMarginStart == 0 ? (0 - view.getHeight()) : 0);
		view.setVisibility(View.VISIBLE);
	}
	
	public boolean getIsVisibleAfter(){
		return mIsVisibleAfter;
	}
	
	public static void initViewMargin(View view,int height){
		LayoutParams mViewLayoutParams = (LayoutParams) view.getLayoutParams();
		mViewLayoutParams.bottomMargin = -height;
		view.requestLayout();
	}

	public boolean ismWasEndedAlready() {
