...
public class RadialTextsView extends View {
    ...
    public ObjectAnimator getDisappearAnimator() {
        if (!mIsInitialized || !mDrawValuesReady || mDisappearAnimator == null) {
            Log.e(TAG, "RadialTextView was not ready for animation1.");
            return null;
        }
    ...
    public ObjectAnimator getReappearAnimator() {
        if (!mIsInitialized || !mDrawValuesReady || mReappearAnimator == null) {
        	System.out.println(mIsInitialized+"  "+mDrawValuesReady+" "+mReappearAnimator);
            Log.e(TAG, "RadialTextView was not ready for animation2.");
            renderAnimations();
