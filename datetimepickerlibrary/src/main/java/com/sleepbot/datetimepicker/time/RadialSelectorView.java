...
public class RadialSelectorView extends View {
    ...
    public ObjectAnimator getDisappearAnimator() {
        if (!mIsInitialized || !mDrawValuesReady) {
            Log.e(TAG, "RadialSelectorView was not ready for animation.1");
            return null;
        }
    ...
    public ObjectAnimator getReappearAnimator() {
        /*if (!mIsInitialized || !mDrawValuesReady) {
        	System.out.println(mIsInitialized+"  "+mDrawValuesReady+" ");
            Log.e(TAG, "RadialSelectorView was not ready for animation.2");
            return null;
        }*/
